...
import com.intechcore.scomponents.fx.menubuilder.control.FxToggleButtonBuilder;
...
/**
 * A factory for creating menu items
...
public class MenuItemFactory<TCustomParam> {
    ...
    /**
     * Constructs a new MenuItemFactory
     * @param commandFactory the command factory
     * @param eventManagerFuture the event manager future
    ...
    /**
     * Creates a list of menu items from a stream of command configs
     * @param source the stream of command configs
     * @return the list of created menu items
     */
