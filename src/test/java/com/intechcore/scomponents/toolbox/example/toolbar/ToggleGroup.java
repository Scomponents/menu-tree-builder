...
/**
 * An enum that represents the toggle groups in the example application
 */
public enum ToggleGroup implements ICommandGroup<ToggleGroup> {
    /**
     * The first toggle group
     */
    TOGGLE_GROUP1
}
